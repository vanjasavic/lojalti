...
export default function Login() {
    ...
    return (
        ...
        <Welcome />
            ...
            <div>
                <button onClick={loginFacebook} className="uk-button uk-button-primary uk-align-center uk-border-rounded uk-width-1-1"><span data-uk-icon="facebook"></span> Facebook</button>
